...
import { getTrack } from '@/data/playlist'

export default function MusicButton({ trackId }: { trackId: string }) {
  ...
  return (
    <button
      onClick={handleClick}
      className="flex items-center gap-3 w-full rounded-xl px-4 py-3 text-left transition-transform active:scale-[0.98]"
